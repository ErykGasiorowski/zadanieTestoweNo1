...
class CurrencyAViewController: UIViewController, TablesToggleViewDelegate {
...
//        getCurrencyAData()
    ...
    @objc func didRefresh() {
        ...
        APICaller.shared.getCurrencyAData(for: currency, with: startDate, with: endDate, with: tableType!) { result in
